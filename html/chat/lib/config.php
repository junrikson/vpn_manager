...
// Database username:
$config['dbConnection']['user'] = 'chatbox';
// Database password:
$config['dbConnection']['pass'] = 'vpnku';
// Database name:
$config['dbConnection']['name'] = 'chatbox';
// Database type:
